...
from app.models import Role, User, Student, DormBuilding, Guest
...
def make_shell_context():
    ...
    """
    return dict(db=db, User=User, Role=Role, Student=Student, DormBuilding=DormBuilding, Guest=Guest)
