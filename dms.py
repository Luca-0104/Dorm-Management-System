...
from app.models import Role, User, Student, DormBuilding, Guest, DAdmin, Tools
...
def make_shell_context():
    ...
    """
    return dict(db=db, Tools=Tools, User=User, Role=Role, Student=Student, DormBuilding=DormBuilding, Guest=Guest, DAdmin=DAdmin)
